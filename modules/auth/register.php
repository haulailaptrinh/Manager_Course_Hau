                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input name="fullname" type="text" class="form-control form-control-lg"
                                value="<?php echo oldData($oldData ?? [], 'fullname')?>" placeholder="Họ tên" />
                            <?php echo formErorrs($errorsArr ?? [], 'fullname'); ?>
                        </div>
                        <!-- Email -->
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input name="email" type="text" class="form-control form-control-lg"
                                value="<?php echo oldData($oldData ?? [], 'email')?>" placeholder="Địa chỉ email" />
                            <?php echo formErorrs($errorsArr ?? [], 'email'); ?>
                        </div>
                        <!-- Phone -->
                        <div data-mdb-input-init class="form-outline mb-4">
