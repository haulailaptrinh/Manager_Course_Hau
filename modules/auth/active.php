...
// Kiểm tra xem active_token ở url có giống active_token trong csdl (users)
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <?php
                if(!empty($checkToken)):
                    ...
                    $condiction = 'id = ' . $checkToken['id'];
                    update('users',$data,$condiction); 
                    ?>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <a href="<?php echo _HOST_URL; ?>?module=auth&action=login" class="link-danger" style="font-size: 20px; 
                    color: blue !important;">Đăng nhập ngay</a></p>
            </div>
            <?php
                else:
                    ?>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                    <h2 class="fw-normal mb-5 me-3">Kích hoạt tài khoản không thành công. Đường link đã hết hạn.
                    </h2>
                </div>
            </div>
            <?php
    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <a href="<?php echo _HOST_URL; ?>?module=auth&action=login" class="link-danger" style="font-size: 20px;
                    color: blue !important;">Quay trở lại</a></p>
            </div>
        </div>
    </div>
</section>
